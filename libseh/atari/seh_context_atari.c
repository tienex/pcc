 ...
 * Exception Context Handling for Atari TOS/GEM
 */

#include <string.h>
#include "../seh.h"

/* Atari 68000 context - limited support */
...
{
	/* Limited restore capability on TOS */
}

void
_seh_extract_signal_context(void *sigcontext, struct _seh_exception_record *exc)
{
	/* TOS doesn't provide exception context in standard way */
}
