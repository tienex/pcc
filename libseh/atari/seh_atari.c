 ...
 * SEH Runtime Implementation for Atari TOS/GEM
 *
 * Atari TOS is mostly single-tasking, though MiNT adds multitasking.
 * Exception handling uses GEMDOS/BIOS traps.
 */
...
/* TOS is single-tasking - no TLS needed */
                     ...
                     unsigned long nparams, unsigned long *params)
{
	...
	/* No handler - print error to console */
