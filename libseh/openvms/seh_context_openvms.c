 ...
 * Exception Context Handling for OpenVMS
 */

#include "../seh.h"
#include <string.h>

/* OpenVMS context uses mechanism vector and signal array */

void _seh_save_context(void *context) { if (context) memset(context, 0, 512); }
