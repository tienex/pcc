 ...
 * SEH Runtime Implementation for UEFI
 *
 * UEFI (Unified Extensible Firmware Interface) environment
 * Single-threaded firmware environment with limited exception handling
 */
...
/* UEFI is single-threaded - use global storage */
                     ...
                     unsigned long nparams, unsigned long *params)
{
	...
	/* Unhandled exception in UEFI */
	/* UEFI has limited console output */
	abort();
}
