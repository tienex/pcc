 ...
 * SEH Runtime Implementation for Windows 16-bit
 *
 * Windows 16-bit has limited exception handling support.
 * Uses setjmp/longjmp similar to DOS.
 */
...
/* Exception chain (no TLS in Win16) */
