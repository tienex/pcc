 ...
 * SEH Runtime Implementation for Mac OS Classic (pre-OSX)
 *
 * Mac OS Classic (System 7-9) has limited exception handling.
 * Uses setjmp/longjmp approach similar to other classic systems.
 */
...
/* Mac OS Classic is cooperative multitasking - no true TLS */
