 ...
 *
 * Clang-style error reporting for PL/I compiler
 */
...
extern const char *current_file;  /* Current source file */
extern int current_line;    /* Current line number */
extern int current_column;  /* Current column number */

/* Diagnostic flags */
extern int warn_unused;     /* Warn about unused variables */
extern int warn_conversion; /* Warn about implicit conversions */
extern int warn_strict;     /* Strict PL/I compliance warnings */
...
/* Emit diagnostic with source context */
